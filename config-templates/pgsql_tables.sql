...
CREATE INDEX IF NOT EXISTS statistics_detail_i1 ON statistics_detail (sourceIdp);
CREATE INDEX IF NOT EXISTS statistics_detail_i2 ON statistics_detail (service);
CREATE INDEX IF NOT EXISTS statistics_detail_i3 ON statistics_detail (userid);
